...
\hypersetup{
  pdftitle={Analyse de GermanCredit avec les methodes de Machine Learning},
  pdfauthor={Schadra Ange Mulekya},
  hidelinks,
...
\title{Analyse de GermanCredit avec les methodes de Machine Learning}
...
Reference a figure by its code chunk label with the \texttt{fig:} prefix
...
\CommentTok{\#datatable(GermanCredit,options = list(pageLength = 5))}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#datatable(GermanCredit,class = \textquotesingle{}cell{-}border stripe\textquotesingle{})}
\end{Highlighting}
\end{Shaded}
